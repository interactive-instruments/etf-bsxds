 ...
 */
final class BsxDsCalledTestCaseResultCollector extends AbstractTestCaseResultCollector {
	 ...
	 */
	BsxDsCalledTestCaseResultCollector(final AbstractTestCaseResultCollector parentCollector, final IFile testCaseResultFile) {
	 ...
	 * @param parentCollector
	 */
	BsxDsCalledTestCaseResultCollector(final AbstractTestCaseResultCollector parentCollector, boolean forTestCase) {
		super(forTestCase ? TestCaseResultCollectorState.WRITING_TEST_CASE_RESULT : TestCaseResultCollectorState.WRITING_TEST_STEP_RESULT);
		this.parentCollector = parentCollector;
	...
	@Override protected AbstractTestCollector createCalledTestCaseResultCollector(final AbstractTestCollector parentCollector, final String testModelItemId, final long startTimestamp) {
		return new BsxDsCalledTestCaseResultCollector(this);
	}
