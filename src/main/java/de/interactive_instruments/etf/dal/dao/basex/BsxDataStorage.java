...
public final class BsxDataStorage implements BsxDsCtx, DataStorage {
    ...
    /**
     * As the Dtos are not implementing interfaces, the InvocationHandler can not be used for proxying method calls. Therefore, new classes are generated at runtime and method calls are proxied to the {@link LazyLoadProxyDto} class.
     *
