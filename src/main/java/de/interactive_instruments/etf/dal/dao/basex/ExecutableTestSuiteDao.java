 ...
 */
public class ExecutableTestSuiteDao extends BsxWriteDao<ExecutableTestSuiteDto> {

	protected ExecutableTestSuiteDao(final BsxDsCtx ctx) throws StoreException {
