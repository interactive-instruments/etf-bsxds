# ETF Data Storage based on BaseX (ii fork)
...
This fork of the ETF component [etf-bsxds](https://github.com/etf-validator/etf-bsxds) is used by interactive instruments to implement and test new features before they are merged back into the master branch.
